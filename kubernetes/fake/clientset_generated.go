...
import (
	...
	fakediscovery "FlorianOtel/client-go/discovery/fake"
	kubernetes "FlorianOtel/client-go/kubernetes"
	v1beta1apps "FlorianOtel/client-go/kubernetes/typed/apps/v1beta1"
	fakev1beta1apps "FlorianOtel/client-go/kubernetes/typed/apps/v1beta1/fake"
	v1beta1authentication "FlorianOtel/client-go/kubernetes/typed/authentication/v1beta1"
	fakev1beta1authentication "FlorianOtel/client-go/kubernetes/typed/authentication/v1beta1/fake"
	v1beta1authorization "FlorianOtel/client-go/kubernetes/typed/authorization/v1beta1"
	fakev1beta1authorization "FlorianOtel/client-go/kubernetes/typed/authorization/v1beta1/fake"
	v1autoscaling "FlorianOtel/client-go/kubernetes/typed/autoscaling/v1"
	fakev1autoscaling "FlorianOtel/client-go/kubernetes/typed/autoscaling/v1/fake"
	v1batch "FlorianOtel/client-go/kubernetes/typed/batch/v1"
	fakev1batch "FlorianOtel/client-go/kubernetes/typed/batch/v1/fake"
	v2alpha1batch "FlorianOtel/client-go/kubernetes/typed/batch/v2alpha1"
	fakev2alpha1batch "FlorianOtel/client-go/kubernetes/typed/batch/v2alpha1/fake"
	v1alpha1certificates "FlorianOtel/client-go/kubernetes/typed/certificates/v1alpha1"
	fakev1alpha1certificates "FlorianOtel/client-go/kubernetes/typed/certificates/v1alpha1/fake"
	v1core "FlorianOtel/client-go/kubernetes/typed/core/v1"
	fakev1core "FlorianOtel/client-go/kubernetes/typed/core/v1/fake"
	v1beta1extensions "FlorianOtel/client-go/kubernetes/typed/extensions/v1beta1"
	fakev1beta1extensions "FlorianOtel/client-go/kubernetes/typed/extensions/v1beta1/fake"
	v1beta1policy "FlorianOtel/client-go/kubernetes/typed/policy/v1beta1"
	fakev1beta1policy "FlorianOtel/client-go/kubernetes/typed/policy/v1beta1/fake"
	v1alpha1rbac "FlorianOtel/client-go/kubernetes/typed/rbac/v1alpha1"
	fakev1alpha1rbac "FlorianOtel/client-go/kubernetes/typed/rbac/v1alpha1/fake"
	v1beta1storage "FlorianOtel/client-go/kubernetes/typed/storage/v1beta1"
	fakev1beta1storage "FlorianOtel/client-go/kubernetes/typed/storage/v1beta1/fake"
