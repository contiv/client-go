...
import (
	...
	apps "FlorianOtel/client-go/pkg/apis/apps/v1beta1"
	certificates "FlorianOtel/client-go/pkg/apis/certificates/v1alpha1"
	extensions "FlorianOtel/client-go/pkg/apis/extensions/v1beta1"
	metav1 "FlorianOtel/client-go/pkg/apis/meta/v1"
	policy "FlorianOtel/client-go/pkg/apis/policy/v1beta1"
	storageinternal "FlorianOtel/client-go/pkg/apis/storage"
	storage "FlorianOtel/client-go/pkg/apis/storage/v1beta1"
