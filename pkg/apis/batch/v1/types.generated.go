...
import (
	...
	pkg4_resource "FlorianOtel/client-go/pkg/api/resource"
	pkg2_v1 "FlorianOtel/client-go/pkg/api/v1"
	pkg1_v1 "FlorianOtel/client-go/pkg/apis/meta/v1"
	pkg3_types "FlorianOtel/client-go/pkg/types"
	pkg5_intstr "FlorianOtel/client-go/pkg/util/intstr"
	"reflect"
	"runtime"
	time "time"
)
