...
import (
	...
	pkg3_v1 "FlorianOtel/client-go/pkg/api/v1"
	pkg2_v1 "FlorianOtel/client-go/pkg/apis/meta/v1"
	pkg4_types "FlorianOtel/client-go/pkg/types"
	pkg1_intstr "FlorianOtel/client-go/pkg/util/intstr"
	"reflect"
	"runtime"
	time "time"
)
